document.querySelector(".fa-searchengin").addEventListener("click", () => {
  ...
  if (input.value.trim() === "") {
    ...
    .then((data) => {
      ...
      document.getElementById("visibility").innerHTML = `<h5>Visibility</h5><img src="assests/images/visibility.png" class="set" alt=""><h2> ${Math.round(data.visibility) / 1000} km/h</h2>`;
